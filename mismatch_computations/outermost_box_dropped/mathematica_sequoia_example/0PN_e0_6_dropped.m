...
Pi/4 - 2*f*Pi*tc + l*\[Phi]c - 
 (3*l^(8/3)*(1 + x^(3/2)*(-16*Pi + e0^2*((-295945*Pi)/(35088*\[Chi]^(28/9)) + (65561*Pi)/(4080*\[Chi]^(19/9))) + e0^4*((1968982405*Pi)/(35961984*\[Chi]^(47/9)) - (6211173025*Pi)/(102085632*\[Chi]^(38/9)) - 
    ...
    x^2*((5*(3058673 + 5472432*\[Eta] + 4353552*\[Eta]^2))/508032 + e0^4*((3654447011975/98224939008 - (4300262795285*\[Eta])/18124839936 + (392328884035*\[Eta]^2)/1294631424)/\[Chi]^(50/9) + 
        ...
        (-111064865/14141952 - (165068815*\[Eta])/4124736 - (10688155*\[Eta]^2)/294624)/\[Chi]^(19/9))) + e0^4*(5222765/(998944*\[Chi]^(38/9)) - 2608555/(444448*\[Chi]^(19/9))) - (2355*e0^2)/(1462*\[Chi]^(19/9))))/
  (512*2^(2/3)*((f*G*m)/c^3)^(5/3)*Pi^(5/3)*\[Eta])]/.x->(G m 2 \[Pi] F/c^3)^(2/3)/.F->f/l/.\[Chi]->f/f0 (2/l)/.m->mcz/\[Eta]^(3/5)] /.SubsList2 ] ;
...
Export["matchData_0PN_e0_6_dropped.dat", matchData] ;                    
Export["eArray_0PN_e0_6_dropped.dat", eArr] ;

...
t2=PowerExpand[ 
tc+1/x^3 (-((55 G m)/(768 c^3))-(3715 G m)/(64512 c^3 \[Eta])+e0^2 ((-((154645 G m)/(396288 c^3))+(2223905 G m)/(11096064 c^3 \[Eta]))/\[Chi]^(25/9)+((128365 G m)/(340992 c^3)+(2045665 G m)/(9547776 c^3 \[Eta]))/\[Chi]^(19/9)))+((G m \[Pi])/(8 c^3 \[Eta])+e0^2 ((295945 G m \[Pi])/(792576 c^3 \[Eta] \[Chi]^(28/9))-(327805 G m \[Pi])/(626688 c^3 \[Eta] \[Chi]^(19/9))))/x^(5/2)+1/x^2 (-((27145 G m)/(129024 c^3))-(15293365 G m)/(130056192 c^3 \[Eta])-(3085 G m \[Eta])/(18432 c^3)+e0^2 (1/\[Chi]^(31/9) (-((52058845 G m)/(99864576 c^3))-(936702035 G m)/(33554497536 c^3 \[Eta])+(14251675 G m \[Eta])/(14266368 c^3))+1/\[Chi]^(25/9) (-((4917245 G m)/(42964992 c^3))+(5795368945 G m)/(9624158208 c^3 \[Eta])-(25287905 G m \[Eta])/(12275712 c^3))+((165068815 G m)/(143990784 c^3)+(111064865 G m)/(493682688 c^3 \[Eta])+(10688155 G m \[Eta])/(10285056 c^3))/\[Chi]^(19/9)))+(-((5 G m)/(256 c^3 \[Eta]))+(785 e0^2 G m)/(11008 c^3 \[Eta] \[Chi]^(19/9)))/x^4
...
\[Pi]/4-2 f \[Pi] tc+l \[Phi]c+1/(512 2^(2/3) ((f G m)/c^3)^(5/3) \[Pi]^(5/3) \[Eta]) 3 l^(8/3) (-1+x^(3/2) (16 \[Pi]+e0^2 ((295945 \[Pi])/(35088 \[Chi]^(28/9))-(65561 \[Pi])/(4080 \[Chi]^(19/9))))+x (-(3715/756)-(55 \[Eta])/9+e0^2 ((2223905/491232-(154645 \[Eta])/17544)/\[Chi]^(25/9)+(2045665/348096+(128365 \[Eta])/12432)/\[Chi]^(19/9)))+x^2 (-(15293365/508032)-(27145 \[Eta])/504-(3085 \[Eta]^2)/72+e0^2 ((-(936702035/1485485568)-(3062285 \[Eta])/260064+(14251675 \[Eta]^2)/631584)/\[Chi]^(31/9)+(5795368945/350880768-(4917245 \[Eta])/1566432-(25287905 \[Eta]^2)/447552)/\[Chi]^(25/9)+1/\[Chi]^(19/9) (111064865/14141952+(165068815 \[Eta])/4124736+(10688155 \[Eta]^2)/294624)))+(2355 e0^2)/(1462 \[Chi]^(19/9)))
] /.x->(G m 2 \[Pi] F/c^3)^(2/3)/.F->f/l/.\[Chi]->f/f0 (2/l)/.m->mcz/\[Eta]^(3/5)   ]  /.SubsList2;
...
filename="fisher_NLO_in_e0_e0_"<> ToString[e0]<>".dat";                                                              (*ATTENTION PLEASE*)

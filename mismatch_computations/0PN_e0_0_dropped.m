...
\[Phi]S=N[\[Alpha]0+\[Phi]b+\[Pi]/12.+ArcTan[(Sqrt[3]Cos[\[Theta]Sb]+Sin[\[Theta]Sb] (Cos[\[Phi]b] Cos[\[Phi]Sb]+Sin[\[Phi]b] Sin[\[Phi]Sb]))/(2Sin[\[Theta]Sb] (Cos[\[Phi]Sb] Sin[\[Phi]b]-Cos[\[Phi]b] Sin[\[Phi]Sb]))]];
\[Phi]S2= N[\[Phi]S-\[Pi]/4.];
...
\[Phi]SSWF=N[\[Alpha]0+\[Phi]bSWF+\[Pi]/12.+ArcTan[(Sqrt[3]Cos[\[Theta]Sb]+Sin[\[Theta]Sb] (Cos[\[Phi]bSWF] Cos[\[Phi]Sb]+Sin[\[Phi]bSWF] Sin[\[Phi]Sb]))/(2Sin[\[Theta]Sb] (Cos[\[Phi]Sb] Sin[\[Phi]bSWF]-Cos[\[Phi]bSWF] Sin[\[Phi]Sb]))]];
...
Export["matchData_0PN_e0_0_dropped.dat", matchData] ;                    
Export["eArray_0PN_e0_0_dropped.dat", eArr] ;
